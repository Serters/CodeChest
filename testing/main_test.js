...
const snippet_1 = new snippet(1, 'Sample Snippet', 'console.log("Hello, World!");', 'Prints a greeting', 'This snippet prints a simple greeting to the console.', true, 123);
...
const user_1 = new user(456, 'john_doe', 'john@example.com', 'path/to/profile_picture.jpg');
